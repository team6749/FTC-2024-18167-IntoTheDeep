...
@Autonomous(name = "Auto-A-ArmMoveTest")

public class AutoAArmMove extends OpMode {
        ...
        if (stepNbr <= END_STEP_NBR) {
            ...
            switch (stepNbr) {
                case 0:
                    ...
                    while (!robotArm.isAtHighBasketPosition() && (System.currentTimeMillis() - startTime < 3000)){
                        robotArm.rotateToHighBasket();
                    }
//                    robotArm.driveMode();
                    stepNbr++;
                    mStateTime.reset();
